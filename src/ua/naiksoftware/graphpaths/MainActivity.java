...
public class MainActivity extends Activity {
    ...
    private enum Mode {
        ...
        DEIKSTRA, SHIMBELL, SALESMAN_PROBLEM
    }
     ...
     * Called from xml
     */
    public void selectDeikstra(View v) {
     ...
     * Called from xml
     */
    public void selectShimbell(View v) {
     ...
     * Called from xml
     */
    public void selectSalesmanProblem(View v) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            for (int j = 0; j < size; j++) {
                ...
                if (i == j) {
                    ...
                    if (val.isEmpty()) {
                        m[i][j].value = Integer.MAX_VALUE;
                    } else {
                        m[i][j].value = Integer.parseInt(val);
                    }
                }
            }
        }
